...
- (NSString *)documentsDirectory {
    ...
    NSString *docDir = [NSSearchPathForDirectoriesInDomains(NSApplicationSupportDirectory, NSUserDomainMask, YES) lastObject];

     docDir =  [docDir stringByAppendingString:@"/HUPong"];
    ...
    NSLog(@"doc directory is in %@",docDir);
    return docDir;
}
